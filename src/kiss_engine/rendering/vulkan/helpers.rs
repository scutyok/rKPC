...
// Allow unused variables in this module; some platform-dependent code
// may intentionally leave intermediates unused. This suppresses noisy
// warnings while keeping other lints active.
