...
unsafe fn get_max_msaa_samples(
    ...
    // Cap at 4x MSAA for performance — higher sample counts cost significantly more
    // GPU memory bandwidth and resolve time, especially at fullscreen resolutions.
    [
...
pub unsafe fn create_swapchain_image_views(
    ...
    data.swapchain_image_views = data
        ...
        .iter()
        .map(|i| {
            super::helpers::create_image_view(
                device,
                *i,
